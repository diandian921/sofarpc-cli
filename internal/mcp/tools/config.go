...
var configSaveServerInputSchema = json.RawMessage(`{
  ...
  "properties": {
    ...
    "protocol": {"type": "string", "enum": ["bolt"], "default": "bolt", "description": "RPC protocol; only bolt is supported."},
    "timeoutMs": {"type": "integer", "minimum": 1, "description": "Default total timeout in milliseconds."},
